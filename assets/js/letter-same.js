(function() {
    const examples = [{"question":"가와 같은 글자를 골라요.","label":"기준 글자","guide":"같은 글자를 찾아요","target":"가","answer":"가","choices":["가","나","다","라","카","자"],"title":"가 찾기"},{"question":"다와 같은 글자를 골라요.","label":"기준 글자","guide":"같은 글자를 찾아요","target":"다","answer":"다","choices":["라","다","타","가","나","바"],"title":"다 찾기"},{"question":"바와 같은 글자를 골라요.","label":"기준 글자","guide":"같은 글자를 찾아요","target":"바","answer":"바","choices":["파","마","바","사","자","카"],"title":"바 찾기"},{"question":"코와 같은 글자를 골라요.","label":"기준 글자","guide":"같은 음절을 찾아요","target":"코","answer":"코","choices":["고","코","토","오","쿠","카"],"title":"코 찾기"},{"question":"무와 같은 글자를 골라요.","label":"기준 글자","guide":"같은 음절을 찾아요","target":"무","answer":"무","choices":["므","누","무","모","부","구"],"title":"무 찾기"},{"question":"리와 같은 글자를 골라요.","label":"기준 글자","guide":"같은 음절을 찾아요","target":"리","answer":"리","choices":["니","리","디","라","기","비"],"title":"리 찾기"}];
    let currentIndex = 0;
