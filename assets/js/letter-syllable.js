(function() {
    const examples = [{"question":"가와 같은 음절을 골라요.","label":"기준 음절","guide":"첫소리 차이를 봐요","target":"가","answer":"가","choices":["가","카","까","나","다","타"],"title":"가 카 까"},{"question":"카와 같은 음절을 골라요.","label":"기준 음절","guide":"첫소리 차이를 봐요","target":"카","answer":"카","choices":["가","카","까","타","파","바"],"title":"카 가 까"},{"question":"다와 같은 음절을 골라요.","label":"기준 음절","guide":"첫소리 차이를 봐요","target":"다","answer":"다","choices":["다","타","따","라","나","가"],"title":"다 타 따"},{"question":"바와 같은 음절을 골라요.","label":"기준 음절","guide":"첫소리 차이를 봐요","target":"바","answer":"바","choices":["바","파","빠","마","사","자"],"title":"바 파 빠"},{"question":"고와 같은 음절을 골라요.","label":"기준 음절","guide":"첫소리 차이를 봐요","target":"고","answer":"고","choices":["고","코","꼬","도","토","또"],"title":"고 코 꼬"},{"question":"주와 같은 음절을 골라요.","label":"기준 음절","guide":"첫소리 차이를 봐요","target":"주","answer":"주","choices":["주","추","쭈","수","후","누"],"title":"주 추 쭈"}];
    let currentIndex = 0;
