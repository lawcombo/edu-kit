const CACHE_NAME = "edu-kit-pwa-20260812-liaison-title-card-mobile";
...
const LOCAL_ASSETS = [
    ...
    "./sentence-order.html",
    "./letter-same.html",
    "./letter-different.html",
    "./letter-vowel.html",
    "./letter-consonant.html",
    "./letter-syllable.html",
    "./letter-target.html",
    ...
    "./assets/css/letter-same.css",
    "./assets/css/letter-different.css",
    "./assets/css/letter-vowel.css",
    "./assets/css/letter-consonant.css",
    "./assets/css/letter-syllable.css",
    "./assets/css/letter-target.css",
    "./assets/js/app.js",
    "./assets/js/data.js",
    ...
    "./assets/js/letter-same.js",
    "./assets/js/letter-different.js",
    "./assets/js/letter-vowel.js",
    "./assets/js/letter-consonant.js",
    "./assets/js/letter-syllable.js",
    "./assets/js/letter-target.js",
    "./assets/js/pwa.js",
